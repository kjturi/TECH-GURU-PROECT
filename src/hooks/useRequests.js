...
export function useRequests(viewer) {
  ...
  const submitRequest = useCallback(async (requester, form) => {
    await addDoc(collection(db, COLLECTION), {
      ...
      immediateManagerId: form.immediateManagerId,
      immediateManagerName: form.immediateManagerName,
      nextApprovingManagerId: form.nextApprovingManagerId,
      nextApprovingManagerName: form.nextApprovingManagerName,
